...
class StorageRegistration(gui.CTkFrame):
    ...
    def _create_widgets(self):
        ...
        self.step1_label = gui.CTkLabel(self.form_body, text="STEP 1: DEFINE STORAGE NODE", font=gui.CTkFont(size=15, weight="bold"), anchor="w")
        ...
        self.step2_label = gui.CTkLabel(self.form_body, text="STEP 2: DOWNLOAD STORAGE NODE INSTALLER",font=gui.CTkFont(size=15, weight="bold"), anchor="w")
        ...
        self.step2_button = gui.CTkButton(self.form_body,image=self.ctk_download_image, text="Download Storage Node Installer")
